...
function germany() {
    ...
    document.querySelector(".chart").style.height = (bevölkerungDE2022 / bevölkerungEU * 100) + "%";
}
...
function france() {
    ...
    document.querySelector(".chart").style.height = (bevölkerungFR2022 / bevölkerungEU * 100) + "%";
}
...
function italy() {
    ...
    document.querySelector(".chart").style.height = (bevölkerungIT2022 / bevölkerungEU * 100) + "%";
}
...
function portugal() {
    ...
    document.querySelector(".chart").style.height = (bevölkerungP2022 / bevölkerungEU * 100) + "%";
}
 ...
 * }
 */ 
//# sourceMappingURL=eu-scriptt.js.map